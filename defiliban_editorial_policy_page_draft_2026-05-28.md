# DeFiliban Editorial Policy Page Draft

Suggested title: `Editorial Policy`

Suggested meta description: `Read DeFiliban's editorial policy, including sourcing standards, corrections, transparency, and coverage principles for DeFi and crypto reporting.`

Suggested slug: `editorial-policy`

## Page Copy

# Editorial Policy

DeFiliban covers decentralized finance, onchain market structure, and blockchain infrastructure with a focus on clarity, sourcing, and useful context.
...
- protocols such as decentralized exchanges, lending markets, derivatives, and stablecoins
- yield systems such as staking, farming, and strategy design
- liquidity structures such as pools, AMMs, and capital flows
- risk events such as exploits, liquidations, and smart contract failures
- infrastructure such as bridges, oracles, and Layer 2 networks

We also cover policy, market structure, and industry developments when they materially affect onchain users, builders, or capital allocation.

## Editorial Principles

Our editorial work is guided by a few core principles:

- accuracy before speed
- clarity over hype
- attribution over assumption
- context over headline noise
...
- verifiable onchain or market data
...
Crypto markets and protocol developments move quickly, and material facts can change after publication.
...
Editorial content should be distinguishable from sponsored or promotional material.
...
DeFiliban publishes work under identified contributors, and we expect author pages to help readers understand who wrote a piece and what that writer covers.

You can learn more about our contributors on our [Authors](https://defiliban.io/authors/) page and our publication background on our [About](https://defiliban.io/about/) page.

## Contact

If you believe an article contains a factual issue, needs clarification, or raises an editorial concern, please contact us through our [Contact](https://defiliban.io/contact/) page.
...
- Only publish once the team is comfortable standing behind the wording.
- When the corrections page exists, replace the plain text mention with a real internal link.
- If sponsored content is used regularly, add a short section describing disclosure labels more specifically.
