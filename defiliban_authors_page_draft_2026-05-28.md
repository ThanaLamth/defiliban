# DeFiliban Authors Page Draft

Suggested title: `Authors`

Suggested meta description: `Meet the DeFiliban authors covering DeFi protocols, yield, liquidity, risk, and blockchain infrastructure.`

Suggested slug: `authors`

## Page Copy

# Authors

The DeFiliban editorial team covers decentralized finance, onchain market structure, and blockchain infrastructure through a mix of reporting, analysis, and research-driven explainers.

This page introduces the writers currently contributing to DeFiliban and links to their individual author archives.
...
Together, the current DeFiliban contributors cover the site’s core editorial areas:

- protocols, including DEXs, lending markets, derivatives, and stablecoins
- yield, including staking, farming, and strategy design
- liquidity, including pools, AMMs, and capital flows
- risk, including exploits, liquidations, and smart contract failures
- infrastructure, including bridges, oracles, and Layer 2 networks
...
- Add internal links to the related pages once they exist.
- If author headshots or verified social/profile links become available, add them to each author archive page first, then consider surfacing them here.
